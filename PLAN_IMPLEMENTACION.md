...
| P1        | `[x]`  | **Cola local durable**: recetas encoladas, reintento explícito, cancelación y recibos; nunca publicar un resultado parcial en modo atómico.                                                     | La receta/recibo sobrevive reinicios; la cancelación cooperativa termina sólo el batch atómico ya iniciado. |
