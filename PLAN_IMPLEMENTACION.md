...
- [~] `F07-T35` Accesibilidad básica y warnings de contraste/orden solo como heurística. — `metadata_manage` establece `aria-label`, `aria-hidden`, title y desc por elemento con IDs explícitos; pruebas MCP cubren el flujo. Los warnings de contraste/orden siguen pendientes.
