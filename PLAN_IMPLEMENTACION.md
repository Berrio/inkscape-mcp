...
- [~] `F07-T37` Implementar edición de nodos tipada: insertar/mover/eliminar, cambiar comando, handles, abrir/cerrar subpath y mantener índices/revisión. — `path_node_move` mueve endpoints absolutos M/L/T/Q/C/S/A y `path_node_edit` inserta/elimina/retaggea L/T y abre/cierra subpaths, todo con índice, revisión y backup; edición de handles, H/V/relativos y estabilidad de índices tras transformaciones complejas siguen pendientes.
...
- [~] `F07-T40` Implementar inventario/aplicación de paletas y swatches documentales sin depender de preferencias globales. — `palette_inspect` inventaría colores hex locales de fill/stroke/stops y sus usos, sin leer preferencias globales; aplicar paletas, variables y swatches sigue pendiente.
