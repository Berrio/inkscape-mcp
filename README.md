...
La [referencia de tools](./docs/tool-reference.md) cubre las 81 tools
...
| Diseño             | `elements_create`, `connector_create`, `connector_retarget`, `elements_query`, `elements_update`, `elements_delete`, `elements_transform`, `elements_flatten_transform`, `elements_arrange`, `elements_group`, `elements_duplicate`, `elements_reparent`, `elements_align`, `elements_distribute` |
| Texto y paths      | `text_manage`, `text_path_manage`, `flowed_text_inspect`, `flowed_text_convert`, `text_to_paths`, `paths_combine`, `paths_boolean`, `path_modify`, `path_break_apart`, `path_reverse`, `path_node_move`, `path_node_edit`, `path_effects_inspect`                                                 |
