...
- [~] `F07-T37` Implementar edición de nodos tipada: insertar/mover/eliminar, cambiar comando, handles, abrir/cerrar subpath y mantener índices/revisión. — `path_node_move` mueve endpoints absolutos M/L/H/V/T/Q/C/S/A y `path_node_edit` inserta/elimina/retaggea L/T, abre/cierra subpaths y edita handles Q/C y parámetros A, todo con índice, revisión y backup; comandos relativos y estabilidad de índices tras transformaciones complejas siguen pendientes.
