...
| JPG/WebP/TIFF                         | Ninguno                                                                   | No anunciado         | La instalación contiene las extensiones, pero la sonda WebP headless no generó artefacto verificable. JPG/TIFF siguen sin adapter, verifier de export y smoke propio; no se anuncian por la mera presencia de un codec o input type.                                                          |
