...
| `document_resize`         | Documento/revisión, target tipado y modo permitido; devuelve backup/revisión/diff y fidelidad de contenido acotados. | Cambiar lienzo con `page_only` o escalar contenido sólo cuando su CSS/geométría puede preservarse. |
