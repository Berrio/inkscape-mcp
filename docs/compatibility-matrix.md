...
| EMF/WMF/XAML                          | Ninguno                                                                   | No implementado   | Aunque el schema interno enumere formatos futuros, el servidor público no los anuncia sin verificador y fixture propios.                                                           |
