...
| BMP/TIFF no comprimidos, PNG/JPEG/GIF/WebP          | `document_import_raster`                  | Probado           | Sniffing de bytes, límites de tamaño/megapíxeles y wrapper SVG; BMP y TIFF se limitan a datos no comprimidos, GIF puede conservar una limitación de renderer y JPEG no aplica EXIF. |
