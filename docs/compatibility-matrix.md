...
| BMP/PNG/JPEG/GIF/WebP                               | `document_import_raster`                  | Probado           | Sniffing de bytes, límites de tamaño/megapíxeles y wrapper SVG; BMP se limita a DIB no comprimido, GIF puede conservar una limitación de renderer y JPEG no aplica EXIF. |
