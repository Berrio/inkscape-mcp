...
La [referencia de tools](./docs/tool-reference.md) cubre las 71 tools
...
| Texto y paths      | `text_manage`, `text_path_manage`, `text_to_paths`, `paths_combine`, `paths_boolean`, `path_modify`, `path_break_apart`, `path_reverse`, `path_node_move`                                                                                               |
