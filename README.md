...
| Diseño             | `elements_create`, `connector_create`, `connector_retarget`, `connector_route`, `elements_query`, `elements_update`, `elements_delete`, `elements_transform`, `elements_flatten_transform`, `elements_arrange`, `elements_group`, `elements_duplicate`, `elements_reparent`, `elements_align`, `elements_distribute` |
