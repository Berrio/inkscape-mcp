...
| `document_export`             | Un `ExportSpec` discriminado de PNG/PDF/SVG/plain SVG/PS/EPS/EMF/WMF/DXF. | Exportar DXF por `inkscape-dxf/v1`, con acknowledgement explícito de fidelidad limitada. |
